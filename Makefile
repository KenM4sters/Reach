...
BUILD_DIR = bin
C_FILES = ./src/*.cpp ./src/Context/OpenGL/*.cpp ./src/Renderer/*.cpp ./vendor/glad/*.cpp ./vendor/ImGui/*.cpp ./src/Interface/*.cpp 
HEADER_FILES = -I./src/*.h -I./src/Context/OpenGL/*.h  -I./src/Renderer/*.h -I./src/Interface/*.h
