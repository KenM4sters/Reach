...
BUILD_DIR = bin
C_FILES = ./src/*.cpp ./src/Context/OpenGL/*.cpp ./src/Renderer/*.cpp ./vendor/glad/*.cpp ./vendor/ImGui/*.cpp ./src/Interface/*.cpp ./src/Camera/*.cpp
HEADER_FILES = -I./src/*.h -I./src/Context/OpenGL/*.h  -I./src/Renderer/*.h -I./src/Interface/*.h -I./src/Camera/*.h
APP_INCLUDES = -I$(INCLUDES_PATH) -framework Cocoa -framework OpenGL -framework IOkit 
